...
//	public static final String DB_CONNECTION_PASSWORD= "ZleqTah("  ;
	...
	//---------- for insert ----------------
		...
		public Insert(){
			...
			panel1.add(first_name); panel1.add(JT_first_name);
			panel1.add(last_name);panel1.add(JT_last_name);
			panel1.add(age);panel1.add(JT_age);
			
			button1.setMnemonic(KeyEvent.VK_C);
			button2.setMnemonic(KeyEvent.VK_M);
			panel1.add(sexe); panel1.add(controlPanel);group.add(button1);group.add(button2);
			controlPanel.add(button1); controlPanel.add(button2);
			panel1.add(adress);panel1.add(JT_adress);
			panel1.add(activity);panel1.add(JT_activity);
			
			panel1.add(submit);
			panel1.add(exit);panel1.add(back);
		...
		public void actionPerformed(ActionEvent e) {
			...
			ProtocoleHandler c = new ProtocoleHandler();
			
			
			
			
		
				String nameFIRST = JT_first_name.getText();
				String nameLAST = JT_last_name.getText();
				int ageCH = Integer.parseInt(JT_age.getText());
				String sexe ;
				...
				String ActivityCH = JT_activity.getText();
				String adressCH = adress.getText();
